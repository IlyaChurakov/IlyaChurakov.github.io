...
/* harmony import */ var _modules_promoSlider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/promoSlider */ "./src/js/modules/promoSlider.js");
...
/* harmony import */ var _modules_examples__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/examples */ "./src/js/modules/examples.js");
...
/* harmony import */ var _modules_tabletAdaptation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/tabletAdaptation */ "./src/js/modules/tabletAdaptation.js");
/* harmony import */ var _modules_drop__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/drop */ "./src/js/modules/drop.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_promoSlider__WEBPACK_IMPORTED_MODULE_0__["default"])('.main-slider-item', 'vertical', '', '', '', 10000);
  Object(_modules_promoSlider__WEBPACK_IMPORTED_MODULE_0__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn', 'left', 10000);
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_2__["default"])('.accordion-heading', '.accordion-block');
  Object(_modules_examples__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_4__["default"])('.button-styles', '#styles .row');
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_5__["default"])('.portfolio-menu > li', '.portfolio-block', '.lovers', '.chef', '.girl', '.guy');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_tabletAdaptation__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_drop__WEBPACK_IMPORTED_MODULE_8__["default"])();
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_11__["default"])('[name="name"]', /[^а-яё \t]/ig);
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_11__["default"])('[name="message"]', /[^а-яё 0-9 \t]/ig);
});
...
function accordion(tapElem, info) {
  var headers = document.querySelectorAll(tapElem); //       blocks = document.querySelectorAll(info);
  // blocks.forEach(item => {
  //     item.classList.add('animated', 'fadeIn');
  //     item.classList.add('accordion-block-hidden');
  // });
  // headers.forEach((item, num) => {
  //     item.addEventListener('click', function() {
  //         this.classList.toggle('accordion-heading-active');
  //         blocks[num].classList.toggle('accordion-block-hidden');
  //     });
  // });
  ...
  headers.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      if (this.classList.contains('accordion-heading-active')) {
...
function checkTextInputs(selector, regex) {
  var txtInputs = document.querySelectorAll(selector);
  txtInputs.forEach(function (item) {
    Regular(item, regex); //Передаем инпут, который проверяем, и выражение-шаблон
  });
  ...
  function Regular(input, reg) {
    input.addEventListener('input', function (e) {
      ...
      if (input.value.match(regex)) {
        ...
        var circle = input.value.length; //Берем изначальное значение длины

        for (var i = 0; i < circle; i++) {
          //Запускаем цикл, который пройдется столько раз, сколько было символов в самом начале
          if (input.value.match(regex)) {
...
function drop() {
  ...
  ['dragenter', 'dragleave', 'gradover', 'drop'].forEach(function (eventName) {
  ...
  function preventDefaults(e) {
    e.preventDefault();
    e.stopPropagation(); //Останавливает всплытие, чтобы обрабатывалось только событие с целевого элемента, а не с его родителей и т.д.
  }
  ...
  ['dragenter', 'gradover'].forEach(function (eventName) {
    fileInputs.forEach(function (input) {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      if (input == document.querySelector('#promoInput')) {
        bindPostData(input.files[0]);
      }

      if (input.previousElementSibling && input.previousElementSibling.closest('.file_upload')) {
        if (input.files[0].name.length > 11) {
          input.previousElementSibling.textContent = input.files[0].name.substring(0, 11) + '...';
        } else {
  ...
  function bindPostData(file) {
    var statusMessage = document.createElement('div');
    document.querySelector('#promoInput').parentNode.appendChild(statusMessage);
    var formData = new FormData();
    formData.append('File:', file);
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_2__["postData"])('assets/file.php', formData).then(function (res) {
      console.log(res);
    }).catch(function () {
      console.log('Error');
    });
...
function examples() {
  ...
  function showImg(block) {
    ...
    block.querySelectorAll('p:not(.sizes-hit)').forEach(function (i) {
...
function filterItems(itemsSelector, blocksSelector, loversSelector, chefSelector, girlSelector, guySelector) {
  var items = document.querySelectorAll(itemsSelector),
      wrapper = document.querySelector('.portfolio-wrapper'),
      noPortfolio = document.querySelector('.portfolio-no'),
      blocks = wrapper.querySelectorAll(blocksSelector),
      lovers = wrapper.querySelectorAll(loversSelector),
      chef = wrapper.querySelectorAll(chefSelector),
      girl = wrapper.querySelectorAll(girlSelector),
      guy = wrapper.querySelectorAll(guySelector);
  ...
  function showChoiceBlocks(items) {
    items.forEach(function (item) {
...
/* harmony default export */ __webpack_exports__["default"] = (filterItems);
...
function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      if (item.previousElementSibling && item.previousElementSibling.closest('.file_upload')) {
        if (item.files[0].name.length > 11) {
          item.previousElementSibling.textContent = item.files[0].name.substring(0, 11) + '...';
        } else {
  ...
  function bindPostData(form) {
    form.addEventListener('input', function () {
      ...
      if (size.value !== '' && material.value !== '') {
        ...
        otherCost = +options.value;

        if (promocode.value == 'IWANTPOPART') {
          generalCost = sizeCost + materialCost + otherCost - (sizeCost + materialCost + otherCost) / 100 * 30;
        } else {
          generalCost = sizeCost + materialCost + otherCost;
        } // console.log(size.textContent);


        result.textContent = generalCost;
      } else {
        // console.log(size.textContent);
    ...
    form.addEventListener('submit', function (e) {
      ...
      function toSendData() {
        ...
        statusImg.classList.add('modal_status_img');
        var textMessage = document.createElement('div');
        textMessage.textContent = message.loading;
        statusMessage.appendChild(textMessage);
        statusMessage.classList.add('modal_status_text');
        ...
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_5__["postData"])(api, formData).then(function (res) {
          console.log(res);
...
function modal() {
  var closeModalBtn = document.querySelectorAll('.popup-close'),
      popupConsult = document.querySelector('.popup-consultation'),
      btns = document.querySelectorAll('.button-design'),
      popupDesign = document.querySelector('.popup-design'),
      btnsConsult = document.querySelectorAll('.button-consultation'),
  ...
  setTimeout(function () {
    ...
    if (!display) {
      showModal(popupConsult);
    }
  }, 60000);

  function clickToShowModal(showBtnSelector, BgSelector) {
    showBtnSelector.addEventListener('click', function (e) {
      if (e.target) {
        e.preventDefault();
      }
  ...
  function clickToCloseModal(BgSelector) {
    BgSelector.addEventListener('click', function (e) {
      closeModalBtn.forEach(function (item) {
        if (e.target == BgSelector || e.target == item) {
  ...
  clickToCloseModal(popupConsult);
  btns.forEach(function (item) {
    clickToShowModal(item, popupDesign);
    clickToCloseModal(popupDesign);
  });
  btnsConsult.forEach(function (item) {
    clickToShowModal(item, popupConsult);
    clickToCloseModal(popupConsult);
  });
  gift.addEventListener('click', function () {
    showModal(popupGift);
    gift.remove();
    clickToCloseModal(popupGift);
  });
...
function sliders(slides, dir, prev, next, side, timing) {
  var slideIndex = 1,
      paused = false;
...
function scrolling(upSelector) {
  var btnUp = document.querySelector(upSelector);
...
/***/ "./src/js/modules/tabletAdaptation.js":
/*!********************************************!*\
  !*** ./src/js/modules/tabletAdaptation.js ***!
  \********************************************/
/*! exports provided: default */
