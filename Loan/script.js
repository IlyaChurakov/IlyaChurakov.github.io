...
/* harmony import */ var _modules_modules__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modules */ "./src/js/modules/modules.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var sliderMini = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  sliderMini.init();
  var sliderModules = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  sliderModules.init();
  var sliderFeed = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  sliderFeed.init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.showup .play', '.overlay', '.close').init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.video .play', '.overlay', '.close').init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.module__video-item .play', '.overlay', '.close').init();
  new _modules_modules__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officerold .officer__card-item').init();
  new _modules_modules__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew', '.officernew .officer__card-item').init();
  ...
  new _modules_download__WEBPACK_IMPORTED_MODULE_6__["default"]('.module__info-book .download').init();
});
...
/*#__PURE__*/
function () {
  function Download(btnsSelector) {
    _classCallCheck(this, Download);

    this.btns = document.querySelectorAll(btnsSelector);
    this.path = 'assets/files/algorithms.pdf';
  }
  ...
  _createClass(Download, [{
    ...
    value: function downLoadItem(path) {
      ...
      element.setAttribute('download', 'nice_file');
...
function () {
  ...
  _createClass(Forms, [{
    ...
    key: "checkValidation",
    value: function checkValidation(selector, regex) {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.path, formData).then(function (res) {
            ...
            console.log('Ooops...');
            statusImg.setAttribute('src', _this.message.error);
            textMessage.textContent = _this.message.failure;
          }).finally(function () {
            form.reset();
            setTimeout(function () {
    ...
    value: function init() {
      this.bindPostdata();
      this.checkValidation('[name="email"]', /[^a-z 0-9 @ . \t]/ig);
...
/*#__PURE__*/
function () {
  function Modules(containerSelector, elemsSelector) {
  ...
  _createClass(Modules, [{
    ...
    value: function bindBtns() {
      ...
      this.btn.addEventListener('click', function () {
        _this.childes.forEach(function (child) {
          if (!(child == _this.firstChild || child == _this.btn)) {
            _this.items[i].classList.add('animated', 'fadeIn');

            _this.items[i].style.display = 'flex';
          }
        });
        ...
        if (i == 3) {
          _this.btn.closest('.officer__card-item').classList.add('animated', 'fadeOut');

          _this.btn.closest('.officer__card-item').remove();
        }
      });
    }
  }, {
...
/*#__PURE__*/
function () {
  function VideoPlayer(btns, overlay, closeOverlay) {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindCloseBtn() {
      ...
      this.overlay.addEventListener('click', function (e) {
        if (e.target && (e.target == _this2.overlay || e.target == _this2.btnCloseOverlay)) {
...
/*#__PURE__*/
function () {
  function ShowInfo(btnsSelector) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      try {
        ...
        if (n == 3) {
          setTimeout(function () {
            _this.hanson.classList.add('fadeInUp');
    ...
    value: function bindTriggers() {
      ...
      this.scheduleBtns = document.querySelectorAll('.menu__block-schedule');
      this.scheduleBtns.forEach(function (btn, i) {
        btn.addEventListener('click', function () {
      ...
      try {
        this.btnToModules = document.querySelectorAll('.showup__content-explore .plus');
        this.btnToModules.forEach(function (btn) {
          btn.addEventListener('click', function () {
